<%@ Page Title="" Language="C#" MasterPageFile="~/App/Principal_Usuario.Master" AutoEventWireup="true" CodeBehind="Prueba.aspx.cs" Inherits="_IPC2__Proyecto.App.Prueba" %>
    ...
    <table class="w-100">
        ...
        <tr>
                ...
                <table class="w-100" style="height: 32px">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btCancelar" runat="server" Text="Cancelar" Width="200px" CssClass="btn btn-primary"/>
            ...
            <td>
                ...
                <asp:Button ID="btModificar" runat="server" Text="Modificar" Width="200px" CssClass="btn btn-primary"/>
