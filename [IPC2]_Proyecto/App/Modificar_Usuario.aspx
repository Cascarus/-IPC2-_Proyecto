<%@ Page Title="" Language="C#" MasterPageFile="~/App/Principal_Admin.Master" AutoEventWireup="true" CodeBehind="Modificar_Usuario.aspx.cs" Inherits="_IPC2__Proyecto.App.Modificar_Usuario" %>
    ...
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btModificar" runat="server" Text="Modificar" Width="200px" CssClass="btn btn-primary" OnClick="btModificar_Click"/>
