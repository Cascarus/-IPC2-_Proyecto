<%@ Page Title="" Language="C#" MasterPageFile="~/App/Principal_Admin.Master" AutoEventWireup="true" CodeBehind="Crear_Novedades.aspx.cs" Inherits="_IPC2__Proyecto.App.Crear_Novedades" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="w-100">
        <tr>
            ...
            <td>
                <h1><strong>Crear Novedad</strong></h1>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
