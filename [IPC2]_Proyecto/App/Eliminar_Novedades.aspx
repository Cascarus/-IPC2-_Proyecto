<%@ Page Title="" Language="C#" MasterPageFile="~/App/Principal_Admin.Master" AutoEventWireup="true" CodeBehind="Eliminar_Novedades.aspx.cs" Inherits="_IPC2__Proyecto.App.Eliminar_Novedades" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <table class="w-100">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescripcion" runat="server" Height="158px" TextMode="MultiLine" Width="480px" MaxLength="200" onkeypress="return this.value.length<=199" CssClass="form-control" Enabled="False"></asp:TextBox>
                        ...
                        <td>
                            <table class="auto-style25">
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <asp:FileUpload ID="fuImagenes" runat="server" Width="484px" accept=".jpg" CssClass="form-control" Enabled="False"/>
                                        </div>
                                        <div>
                                            <br />
                                            <table class="w-100">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Button ID="btSubir" runat="server" Text="Subir" Width="200px" CssClass="btn btn-primary" Enabled="False"/>
