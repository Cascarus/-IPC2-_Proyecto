<%@ Page Title="" Language="C#" MasterPageFile="~/App/Principal_Usuario.Master" AutoEventWireup="true" CodeBehind="Ver_Artista.aspx.cs" Inherits="_IPC2__Proyecto.App.Ver_Artista" %>
                ...
                <table class="auto-style26">
                    <tr>
                        <td class="auto-style29">
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-dark" Text="Informacion" Width="300px" />
                        </td>
                        <td>
                            <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" Text="Album" Width="300px" />
                        </td>
                    </tr>
                </table>
    ...
    <table class="w-100">
                                            ...
                                            <table class="w-100">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Button ID="btSubir" runat="server" Text="Subir" Width="200px" CssClass="btn btn-primary"/>
        ...
        <tr>
            <td>
                ...
                <asp:Button ID="btCancelar" runat="server" Text="Eliminar" Width="200px" CssClass="btn btn-primary" OnClick="btCancelar_Click"/>
            ...
            <td>
                ...
                <asp:Button ID="btAceptar" runat="server" Text="Actualizar" Width="200px" CssClass="btn btn-primary" OnClick="btAceptar_Click"/>
