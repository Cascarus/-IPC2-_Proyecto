...
{
    public partial class Eliminar_Novedades : System.Web.UI.Page
    {
        ...
        protected void btAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "UPDATE Novedades SET id_Estado = 2 WHERE id_Novedad =" + id_novedad;

                DataSet DS = Utilidades.ejecutar(query);
                Response.Write("<script>alert('Novedad ha eliminado!')</script>");
